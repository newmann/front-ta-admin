...
@Component({
    selector: 'byl-dashboard-monitor',
    templateUrl: './monitor.component.html',
    styleUrls: ['./monitor.component.less']
})
export class BylDashboardMonitorComponent implements OnInit, OnDestroy {
    data: any = { };
    tags = [];
    loading = true;
    q: any = {
    ...
    constructor(private http: _HttpClient, public msg: NzMessageService, public router: Router) {}
