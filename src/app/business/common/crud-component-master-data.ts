...
export abstract class BylCrudComponentMasterData<T extends BylMasterDataBaseModel>
    ...
    submitEntity() {
        ...
        console.log('in BylCrudComponentMasterData ', this.businessData);
    ...
    cancelEntity() {
        ...
        console.log('in BylCrudComponentMasterData submitform', this.businessData);
    ...
    lockEntity() {
        ...
        console.log('in BylCrudComponentMasterData lockEntity', this.businessData);
    ...
    unlockEntity() {
        ...
        console.log('in BylCrudComponentMasterData unlockEntity', this.businessData);
    ...
    confirmEntity() {
        ...
        console.log('in BylCrudComponentMasterData confirmEntity', this.businessData);
