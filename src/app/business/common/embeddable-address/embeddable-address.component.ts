 ...
 **/
import {Component, ElementRef, forwardRef, Input, OnInit, ViewChild, ViewChildren} from '@angular/core';
...
@Component({
    ...
    providers: [BYL_EMBEDDABLE_ADDRESS_COMPONENT]
})
export class BylEmbeddableAddressComponent implements ControlValueAccessor  {
