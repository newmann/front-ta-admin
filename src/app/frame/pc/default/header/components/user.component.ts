...
@Component({
  ...
  <nz-dropdown nzPlacement="bottomRight">
    ...
    <div nz-menu class="width-sm">
      <div nz-menu-item [nzDisabled]="authDataService.currentUserId" (click)="selfSetting()"><i class="anticon anticon-user mr-sm"></i>个人中心</div>
...
export class BylHeaderUserComponent {
  ...
  selfSetting(){
      this.router.navigate(["/account/crud", this.authDataService.currentUserId]);
  }
